...
namespace ASPDotNetWebApp.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(DotNetCoreMySQLContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
             ...
             */
            return View(await _context.Users.Where(x => x.IsActive == true).ToListAsync());
        }

        // GET: Users/InActive
        public async Task<IActionResult> InActive()
        {
            return View(await _context.Users.Where(x => x.IsActive == false).ToListAsync());
        }
