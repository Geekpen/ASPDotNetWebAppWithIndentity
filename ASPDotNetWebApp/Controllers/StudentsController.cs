...
namespace ASPDotNetWebApp.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(DotNetCoreMySQLContext context)
        {
            _context = context;
        }
        ...
        {
            var dotNetCoreMySQLContext = _context.Student.Include(s => s.Department);
        ...
        public async Task<IActionResult> Create([Bind("ID,FullName,RollNumber,CGPA,DepartmentID")] Student student)
        {
            ...
            ViewData["DepartmentID"] = new SelectList(_context.Department, "ID", "DepartmentName", student.DepartmentID);
            return View(student);
        }
